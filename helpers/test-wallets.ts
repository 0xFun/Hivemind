...
export const accounts = [
  {
    // deepcode ignore HardcodedNonCryptoSecret: <please specify a reason of ignoring this>, deepcode ignore HardcodedNonCryptoSecret: <please specify a reason of ignoring this>
